    ...
    <div class="col-12 mb-4">
        ...
        <div class="swiper" id="swiper-3d-coverflow-effect">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide"
                    style="background-image: url(../../assets/img/elements/7.jpg); border-radius: 10px;">
                    Slide 2
                </div>
                <div class="swiper-slide"
                    style="background-image: url(../../assets/img/elements/10.jpg); border-radius: 10px;">
                    Slide 3
                </div>
                <div class="swiper-slide"
                    style="background-image: url(../../assets/img/elements/14.jpg); border-radius: 10px;">
                    Slide 4
                </div>
                <div class="swiper-slide"
                    style="background-image: url(../../assets/img/elements/13.jpg); border-radius: 10px;">
                    Slide 5
                </div>
            </div>
